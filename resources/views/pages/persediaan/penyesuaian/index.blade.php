                    ...
                    @foreach($penyesuaian as $item)
                        <tr>
                            ...
                            <td class="text-end">
                                ...
                                <form action="{{ route('persediaan.penyesuaian.destroy', $item) }}" method="POST" class="d-inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="btn btn-sm btn-outline-danger" onclick="return confirm('Hapus penyesuaian ini?')">
