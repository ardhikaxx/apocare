        ...
        @php
            ...
            $rows = $satuan->map(function ($item) {
                ...
                $aksi = '<div class="d-flex gap-2">'
                    . '<a class="btn btn-sm btn-action-edit" href="' . route('master.satuan.edit', $item) . '"><i class="fa-solid fa-pen"></i></a>'
                    . '<form id="' . $deleteId . '" method="POST" action="' . route('master.satuan.destroy', $item) . '">'
