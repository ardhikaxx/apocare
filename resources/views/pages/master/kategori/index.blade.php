        ...
        @php
            ...
            $rows = $kategori->map(function ($item) {
                ...
                $aksi = '<div class="d-flex gap-2">'
                    . '<a class="btn btn-sm btn-action-edit" href="' . route('master.kategori.edit', $item) . '"><i class="fa-solid fa-pen"></i></a>'
                    . '<form id="' . $deleteId . '" method="POST" action="' . route('master.kategori.destroy', $item) . '">'
