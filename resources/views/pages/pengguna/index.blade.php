        ...
        @php
            ...
            $rows = $pengguna->map(function ($item) {
                ...
                $aksi = '<div class="d-flex gap-2">'
                    . '<a class="btn btn-sm btn-action-edit" href="' . route('pengguna.edit', $item) . '"><i class="fa-solid fa-pen"></i></a>'
                    . '<form id="' . $deleteId . '" method="POST" action="' . route('pengguna.destroy', $item) . '">'
